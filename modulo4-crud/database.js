...
//já existe dentro do módulo fs funções sync
...
class Database {
    ...
    async cadastrar(heroi){
        ...
        const id = heroi.id <= 2 ? heroi.id : Date.now() //simular que tá criando id
        const heroiComId = {
            id,
            ...heroi
        } //concatenar os objetos para retornar em um só

        const dadosFinal = [
            ...dados,
            heroiComId
        ] //concatenar dois objetos num array
